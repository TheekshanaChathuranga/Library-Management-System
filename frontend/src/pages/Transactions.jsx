...
const Transactions = () => {
  ...
  const handleReturnBook = async (transactionId) => {
    ...
    try {
      ...
      // Silent fail - no error message needed
    }
  };
  ...
  const filteredTransactions = transactions
    ...
    .sort((a, b) => {
      ...
      if (sortBy === "transaction_id")
        return (a.transaction_id - b.transaction_id) * order;
      if (sortBy === "due_date")
        return (new Date(a.due_date) - new Date(b.due_date)) * order;
              ...
              >
                ...
                {books.map((book) => (
                  <option key={book.book_id} value={book.book_id}>
                    {book.title} - {book.ISBN} (Available:{" "}
